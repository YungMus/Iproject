...
?>
    ...
    <main>
        <form class="form" method="post" action="registerVoorpagina.inc.php">
            ...
            <h6>Om te kunnen regsitreren vragen wij eerst uw email. Binnen enkelen minuten zult u een verificatiecode Op uw mail ontvangen van ons. vervolgends krijgt u toegang tot de volledige registratie pagina en kunt u begeinnen met uw acccount aan te maken.</h6>
            <label for="form-email">Vul hier je emailadres in
             <br><input type="email" class="form-email" name="Email" id="Email" placeholder="Email">
            </label>
            <p><input type="submit" class="form-button" name="EmailConfirmation"  value="Registreer"></input></p>
