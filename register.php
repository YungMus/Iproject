...
?>
        ...
        <div class="middle-content-section">
                <div class="marketing-site-content-section">
                    ...
                    <div class="marketing-site-content-section-block">
                        ...
                        <p class="marketing-site-content-section-block-subheader subheader">Bij stap 1 vul jij je gebruikersnaam, een wachtwoord en de herhaling van het wachtwoord om je account zo veilig mogelijk te maken.</p>
                    </div>
    ...
    <form method="post" class="multi-step-checkout-form" action="register.inc.php">
                                        ...
                                        <label>
                                            ...
                                            <input type="text" name="Username" id="Username" maxlength="20" pattern="[A-Za-z0-9].{5,}" value="<?php if(isset($_GET['Username'])){ echo $_GET['Username'];} ?>" placeholder="Gebruikersnaam - Minimaal 5 tekens" required >
                                        ...
                                        <div class="small-12 medium-7 column">
                                            <input type="text" name="Lastname" id="Lastname" pattern="[A-Za-z].{1,}" value="<?php if(isset($_GET['Lastname'])){ echo $_GET['Lastname'];} ?>" placeholder="Achternaam" required >
                                        </div>
                                        <div class="small-12 medium-7 column">
