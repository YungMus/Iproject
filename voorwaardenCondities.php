...
?>
    ...
    <div class="textlayout">
        ...
        <br>
        <ul>
            <li>handelingen door u verricht, die zouden zijn ingegeven door de op de website geplaatste informatie;</li>
            <li>de onmogelijkheid de website te gebruiken; en</li>
            <li>het feit dat bepaalde informatie op de website onjuist, onvolledig of niet actueel is.</li>
        </ul>
