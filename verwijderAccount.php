...
<main>
    <form class="form" method="post" action="verwijderAccount.inc.php">
        ...
        <h6>Vul hier uw gebruikersnaam in om te bevestigen dat u het account wil verwijderen. Na het voltooien van deze stap
        ...
        <p>Door op verwijderen te klikken bevestig ik dat ik mijn iConcepts account en al zijn data permanent verwijderen.</p></label>
