...
?>
    <main>
        <form class="form" method="post" action="wachtwoordVergeten.inc.php">
            ...
            <input class="form-input" type="text" name="OldPassword" placeholder="Jouw oude wachtwoord">
            <input class="form-input" type="text" name="NewPassword" placeholder="Jouw nieuwe wachtwoord">
            <input class="form-input" type="text" name="NewPassword-repeat" placeholder="Herhaal jouw nieuwe wachtwoord">
